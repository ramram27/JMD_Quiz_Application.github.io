...
let nameInp = window.prompt("Please Enter valid Name ")

console.log(nameInp);
 let nameUpper = nameInp.toUpperCase();
document.getElementById("nameinp").innerHTML=nameInp
...
function showResult(){
    ...
    if (userScore > 3){
        ...
        let scoreTag = '<span>and nice  , You got <p>'+ userScore +
                       '</p> out of <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else{
